<?php  
	if(isset($_GET['m'])){
		...
		}elseif($_GET['m']=='DaftarUlang'){
			include "module/DaftarUlang/DaftarUlang.php";
		}elseif($_GET['m']=='CetakAbsen'){
			include "module/CetakAbsen/CetakAbsen.php";
		}else{
			...
			<div class='container-fluid'>
				<div class='info-box mb-12 bg-info'>
					...
					<div class='info-box-content'>
						...
						<span class='info-box-text'>Belum ada informasi .....</span>
					</div>
					<!-- /.info-box-content -->
				</div>
				...
				<div class='row'>
					<div class='col-lg-3 col-6'>
						...
						<?php echo "
							...
							<a href='index.php?m=DataPendaftar' class='small-box-footer'>More info <i class='fas fa-arrow-circle-right'></i></a>
						</div>
					</div>
				</div>
				<!-- /.card-footer-->
